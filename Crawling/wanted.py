...
def SearchJob(keyword):
    ...
    wanted.Click_By_CSS_SELECTOR("#__next > div.Search_SearchContainer__aPKM_ > div > div.Search_Search__PUJPw > div:nth-child(3) > div.SearchFilter_FilterButtonList__zbbNL > div:nth-child(2) > button")
    ...
    wanted.Click_By_XPATH("//*[@id=\"__next\"]/div[4]/div/div[2]/div[3]/div[1]/div[2]/div/div[1]/div[3]/button")
