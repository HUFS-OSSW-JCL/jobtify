...
def SearchJob(keyword, area_list):
    ...
    job_list = wanted.ReturnList(list2, "a > div.JobCard_content__5mZPT > strong", "a > div.JobCard_content__5mZPT > span.JobCard_companyContent__zUT91 > span.JobCard_companyName__vZMqJ","a")
    return job_list